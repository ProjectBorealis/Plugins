...
struct POWERIKRUNTIME_API FPowerIKCore
{
	...
	void LoadBonesFromControlRig(FRigBoneHierarchy* Hierarchy);
	...
	void SetSolverBoneTransformsFromControlRig(FRigBoneHierarchy* Hierarchy);
	...
	void CopySolverOutputToControlRig(FRigBoneHierarchy* Hierarchy);
