...
robocopy %BLAST_SOURCE_DIR%\bin\vc15win64-cmake %BLAST_PLUGIN_DIR%\Libraries\Win64 ^
    NvBlast_x64.dll ^
    NvBlast_x64.pdb ^
...
robocopy %BLAST_SOURCE_DIR%\lib\vc15win64-cmake %BLAST_PLUGIN_DIR%\Libraries\Win64 ^
    NvBlast_x64.lib ^
