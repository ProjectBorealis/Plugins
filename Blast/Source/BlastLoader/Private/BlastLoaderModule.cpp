...
void FBlastLoaderModule::StartupModule()
{
	...
	BlastGlobalsHandle = LoadBlastDLL(DllPath, TEXT(BLAST_LIB_DLL_PREFIX "NvBlastGlobals"  BLAST_LIB_DLL_SUFFIX));
	BlastExtSerializationHandle = LoadBlastDLL(DllPath, TEXT(BLAST_LIB_DLL_PREFIX "NvBlastExtSerialization"  BLAST_LIB_DLL_SUFFIX));
	BlastExtShadersHandle = LoadBlastDLL(DllPath, TEXT(BLAST_LIB_DLL_PREFIX "NvBlastExtShaders" BLAST_LIB_DLL_SUFFIX));
	BlastExtStressHandle = LoadBlastDLL(DllPath, TEXT(BLAST_LIB_DLL_PREFIX "NvBlastExtStress" BLAST_LIB_DLL_SUFFIX));
