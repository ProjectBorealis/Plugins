...
void FBlastMeshEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND( Undo, "Undo", "Undo last fracture operation.", EUserInterfaceActionType::Button, FInputChord(EModifierKey::Control, EKeys::Z));
	UI_COMMAND( Redo, "Redo", "Redo next fracture operation.", EUserInterfaceActionType::Button, FInputChord(EModifierKey::Control, EKeys::Y));
