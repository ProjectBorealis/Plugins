...
void FBlastMeshEditorStyle::Initialize()
{
	...
	StyleSet->Set("BlastMeshEditor.Undo", new IMAGE_PLUGIN_BRUSH(TEXT("Icons/icon_BlastMeshEd_Undo_40x"), Icon40x40));
	StyleSet->Set("BlastMeshEditor.Undo.Small", new IMAGE_PLUGIN_BRUSH(TEXT("Icons/icon_BlastMeshEd_Undo_20x"), Icon20x20));
	StyleSet->Set("BlastMeshEditor.Redo", new IMAGE_PLUGIN_BRUSH(TEXT("Icons/icon_BlastMeshEd_Redo_40x"), Icon40x40));
	StyleSet->Set("BlastMeshEditor.Redo.Small", new IMAGE_PLUGIN_BRUSH(TEXT("Icons/icon_BlastMeshEd_Redo_20x"), Icon20x20));
