...
void FBlastLoaderEditorModule::StartupModule()
{
	...
	BlastExtAssetUtilsHandle = LoadBlastDLL(DllPath, TEXT(BLAST_LIB_DLL_PREFIX "NvBlastExtAssetUtils" BLAST_LIB_DLL_SUFFIX));
	BlastExtAuthoringHandle = LoadBlastDLL(DllPath, TEXT(BLAST_LIB_DLL_PREFIX "NvBlastExtAuthoring" BLAST_LIB_DLL_SUFFIX));
